...
func newCredential(db *gorm.DB, opts ...gen.DOOption) credential {
	...
	_credential.ID = field.NewString(tableName, "id")
	_credential.Username = field.NewString(tableName, "username")
	_credential.HashedPassword = field.NewString(tableName, "hashed_password")
...
func (c *credential) updateTableName(table string) *credential {
	...
	c.HashedPassword = field.NewString(table, "hashed_password")
...
func (c *credential) fillFieldMap() {
	...
	c.fieldMap["hashed_password"] = c.HashedPassword
